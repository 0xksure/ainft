...
class SmartContractPromptEnhancementCapability {
    constructor(logger) {
        this.id = "smart-contract-prompt-enhancer";
        this.name = "Smart Contract Prompt Enhancer";
        this.type = "prompt-enhancer";
        this.supportedDomains = ["smart-contract", "blockchain", "solana", "anchor"];
        this.logger = logger;
    }
...
class SmartContractResponseProcessingCapability {
    constructor(logger) {
        this.id = "smart-contract-response-processor";
        this.name = "Smart Contract Response Processor";
        this.type = "response-processor";
        this.logger = logger;
    }
    ...
    addValidationResults(response, validation) {
        let result = response;
...
class SmartContractBlockchainInteractionCapability {
    constructor(logger, connection) {
        this.id = "smart-contract-blockchain-interaction";
        this.name = "Smart Contract Blockchain Interaction";
        this.type = "blockchain-interaction";
        this.logger = logger;
        this.connection = connection;
    }
    async executeCPI(programName, instruction, accounts, data) {
        try {
    ...
    async deploySmartContract(code, options) {
        try {
...
class SmartContractPlugin {
    constructor() {
        this.id = "smart-contract-plugin";
        this.name = "Smart Contract Plugin";
        this.version = "1.0.0";
        this.context = null;
        this.capabilities = [];
    }
    async initialize(context) {
        ...
        this.capabilities = [
            ...
            new SmartContractBlockchainInteractionCapability(context.logger, context.config.connection)
        ];
...
exports.default = SmartContractPlugin;
